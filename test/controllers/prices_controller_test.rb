...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { domain_id: @price.domain_id, from_date: @price.from_date, note: @price.note, price: @price.price, product_id: @price.product_id }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { domain_id: @price.domain_id, from_date: @price.from_date, note: @price.note, price: @price.price, product_id: @price.product_id }
    assert_redirected_to price_path(assigns(:price))
  end
